...
<style>
    ...
    @media print {
        ...
        /*
         * Make invoice and its children visible.
         */
        #invoiceArea,
        #invoiceArea * {
        ...
        /*
         * Invoice becomes the complete printable document.
         */
        #invoiceArea {
        ...
        *::after {
        ...
        /*
         * Do NOT force everything into one page.
         * This is the main fix for invoice cutting.
         */
        .info-card,
        .summary-card,
        .payment-section,
        ...
        /*
         * Payment table rows should not split.
         */
        .payment-table tr {
        ...
        /*
         * Table header repeats on next printed page.
         */
        .payment-table thead {
        ...
        /*
         * Remove Bootstrap/admin spacing that can affect
         * the print layout.
         */
        .container-fluid {
        ...
        /*
         * Important:
         * Do not apply Bootstrap responsive behavior.
         */
        .row {
            ...
            <div class="payment-section">
                ...
                <div class="section-title-row payment-heading">
                    ...
                    <div class="payment-count">
                        ...
                        {{ $booking->payments->count() == 1 ? 'Transaction' : 'Transactions' }}
            ...
            <div class="invoice-bottom">
                ...
                <div class="notes-box">
                    ...
                    <div class="notes-text">
                        ...
                        {{ $booking->remarks ?: 'Thank you for choosing our studio services.' }}
...
<script>
    ...
    */
    ...
    /*
    ============================================================
        OPTIONAL: PRINT BUTTON SHORTCUT
        Ctrl + P will also work normally.
    ============================================================
    */
