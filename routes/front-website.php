...
Route::get('/admission-form', [AdmissionFormController::class, 'admission_form']) ->name('student.admission-form');
Route::post('/save-admission-form', [AdmissionFormController::class, 'save_admission_form']) ->name('student.save-admission-form');
Route::get('/payment-page/{studentCourse}', [AdmissionFormController::class, 'payment_page'])
    ->name('student.payment-page');
Route::post( '/student/payment/{studentCourse}', [AdmissionFormController::class, 'saveStudentPayment'] )->name('student.payment.store');
Route::get( '/student/offline-payment-success/{payment}', [AdmissionFormController::class, 'offlinePaymentSuccess'] )->name('student.offline-payment-success');
